...
body {
    ...
    --dms-background-image-url: url("https://raw.githubusercontent.com/NixOS/nixos-artwork/9d2cdedd73d64a068214482902adea3d02783ba8/logo/nix-snowflake-white.svg"); /* url of the background image */
    --dms-background-image-size: 80%; /* size of the background image (css background-size property) */
